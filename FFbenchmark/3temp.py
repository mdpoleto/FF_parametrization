...
def create_mdp_below(ver,prefix):
	############################################
	# simulation mdp
...
def create_mdp_above(ver,prefix):
	############################################
	# simulation mdp
...
def main(ver,prefix,threshold):
	...
	if not os.path.exists(prefix + ".T0.done"):
		if not os.path.exists(prefix + ".T0.cpt"):

			create_mdp(ver,prefix)

			gromppcommand = "grompp_" + ver + " -f in.T0.mdp -c " + prefix + ".NPT3.gro -p " + prefix + ".top -t " + prefix + ".NPT3.cpt -o " + prefix + ".T0.tpr -po " + prefix + ".T0.mdout.mdp -maxwarn 1"
			os.system(gromppcommand)

			os.system("mdrun_" + ver + " -deffnm " + prefix + ".T0")
			os.system('cp ' +prefix+'.T0.gro '+prefix+'.T0.done')

		else:
			os.system("mdrun_" + ver + " -deffnm " + prefix + ".T0 -cpi " + prefix + ".T0.cpt -append")

	####################################################
	# Running Temperature below

	if not os.path.exists(prefix + ".Tlow.done"):
		if not os.path.exists(prefix + ".Tlow.cpt"):

			create_mdp_below(ver,prefix)

			gromppcommand = "grompp_" + ver + " -f in.Tlow.mdp -c " + prefix + ".NPT3.gro -p " + prefix + ".top -t " + prefix + ".NPT3.cpt -o " + prefix + ".Tlow.tpr -po " + prefix + ".Tlow.mdout.mdp -maxwarn 1"
			os.system(gromppcommand)

			os.system("mdrun_" + ver + " -deffnm " + prefix + ".Tlow")
			os.system('cp ' +prefix+'.Tlow.gro '+prefix+'.Tlow.done')

		else:
			os.system("mdrun_" + ver + " -deffnm " + prefix + ".Tlow -cpi " + prefix + ".Tlow.cpt -append")


	####################################################
	# Running Temperature above
	if not os.path.exists(prefix + ".Thigh.done"):
		if not os.path.exists(prefix + ".Thigh.cpt"):

			create_mdp_above(ver,prefix)

			gromppcommand = "grompp_" + ver + " -f in.Thigh.mdp -c " + prefix + ".NPT3.gro -p " + prefix + ".top -t " + prefix + ".NPT3.cpt -o " + prefix + ".Thigh.tpr -po " + prefix + ".Thigh.mdout.mdp -maxwarn 1"
			os.system(gromppcommand)

			os.system("mdrun_" + ver + " -deffnm " + prefix + ".Thigh")
			os.system('cp ' +prefix+'.Thigh.gro '+prefix+'.Thigh.done')

		else:
			os.system("mdrun_" + ver + " -deffnm " + prefix + ".Thigh -cpi " + prefix + ".Thigh.cpt -append")

print "\n>>> NPT ensembles alredy finished. Moving on...\n"
